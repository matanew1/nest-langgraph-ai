...
export async function fatalRecoveryNode(
  ...
  let finalAnswer = 'An unexpected fatal error occurred. The agent could not complete the task.';
  ...
  logPhaseEnd('FATAL_RECOVERY', 'Providing a graceful fallback response', elapsed());
